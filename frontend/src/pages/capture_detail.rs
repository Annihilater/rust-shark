        ...
        <Layout>
            <div class="max-w-full">
                ...
                <div class="flex items-center gap-4 mb-4">
                    <a href="/captures" class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white transition-colors">
                        "← 返回"
                    </a>
                                        ...
                                        view! {
                                            <tr><td colspan="7" class="text-center py-12 text-gray-500">
                                                <div class="flex flex-col items-center gap-2">
                                                    <div class="text-2xl">"📭"</div>
                                                    <span>"无数据包"</span>
                                                    <span class="text-xs text-gray-400 dark:text-gray-600">"请确认 sharkd 已安装（brew install wireshark）"</span>
                                                </div>
                                            </td></tr>
                                        }.into_any()
                                    } else {
